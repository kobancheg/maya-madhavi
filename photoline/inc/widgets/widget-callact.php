...
class Photoline_Action_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			'Photoline ' . __( 'Call-To-Action', 'photoline' ),
			array(
				'classname' => 'photoline_action_widget', 
				'description' => __( 'Call to Action section', 'photoline' ),
				'width' => 250,
				'height' => 350
			)
		);
 	...
 	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id('text_main'); ?>"><?php _e( 'Main Text:','photoline' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e( 'Button Text:', 'photoline' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('button_url'); ?>"><?php _e( 'Button Link:', 'photoline' ); ?></label>
	...
	<p>
	  <label for="<?php echo $this->get_field_id('background'); ?>"><?php _e( 'Background Color:', 'photoline' ); ?></label> 
