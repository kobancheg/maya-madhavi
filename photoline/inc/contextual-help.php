...
if ( $screen->id == 'themes' ) {
  ...
  $screen->add_help_tab( array(
      ...
      'content' => '<p><strong>' . __( 'Thank you for choosing this Theme!', 'photoline' ) . '</strong></p><p>' . __( 'The Theme has a contextual help for almost all admin screens. More information, help and support you will find on the website <a href="http://www.dinevthemes.com/">DinevThemes</a>.', 'photoline' ) . '</p><p><strong>' . __( 'Quick Start', 'photoline' ) . '</strong></p><p>' . __( 'Using Customizer set your color, upload a logo (avatar - for personal) image, upload a background image (or select any color), upload the image (or select any color) header and other settings.', 'photoline' ) . '</p><p>' . __( 'The theme has page templates for the Home Page. Home Mosaic Tiles and Home Square Tiles Templates show 4 (or more) posts image format. Widgets page template is a Home One Template. Into Home Tagline section can be used plugins shortcode.', 'photoline' ) . '</p><p><strong>' . __( 'Note', 'photoline' ) . '</strong></p><p>' . __( 'An important feature of the theme: templates for categories. You can choose when creating a category or editing a category.', 'photoline' ) . '</p><p>' . __( 'If you want to display the posts without the sidebar just leave blank Sidebar posts.', 'photoline' ) . '</p><p>' . __( 'The theme activates additional fields in the user profile which are used when displaying the Author Box widget.', 'photoline' ) . '</p>',
  ) );
...
if ( $screen->id == 'widgets' ) {
	...
	$screen->add_help_tab( array(
		...
		'title'   => __( 'Theme Features', 'photoline' ),
		'content' =>  '<p><strong>' . __( 'Custom widgets', 'photoline' ) . '</strong></p><p>' . __( 'Built-in widgets this theme is marked Photoline. The theme activates additional fields in the user profile which are used when displaying the widget Author Box. For Blog Intro sidebar using a text widget. If you want to display the posts without the sidebar just leave blank (no widgets) sidebar posts.', 'photoline' ) . '</p><p>' . __( 'The theme has a widgetized homepage using the Home One template.', 'photoline' ) . '</p>',
	) );
}
