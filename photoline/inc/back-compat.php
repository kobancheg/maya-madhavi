...
function photoline_upgrade_notice() {
	$message = sprintf( __( 'Photoline requires at least WordPress version 4.3. You are running version %s. Please upgrade and try again.', 'photoline' ), $GLOBALS['wp_version'] );
...
function photoline_customize() {
	wp_die( sprintf( __( 'Photoline requires at least WordPress version 4.3. You are running version %s. Please upgrade and try again.', 'photoline' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function photoline_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Photoline requires at least WordPress version 4.3. You are running version %s. Please upgrade and try again.', 'photoline' ), $GLOBALS['wp_version'] ) );
	}
}
