...
$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	...
	$wp_customize->add_section(
		...
		array(
			'title'     => __( 'Home Tagline', 'photoline' ),
			'description'  => esc_html__( 'Headlines area for the Homepage. Tagline Text field to type text (can use the html tags, for sample: <h1>Headline</h1>) or paste shortcode. Clear this field to not show Home Tagline.', 'photoline' ),
			'priority'  => 300
		)
	);
		$wp_customize->add_setting(
		...
		$wp_customize->add_control(
			'home_tagline',
				array(
					...
					'label'    => __( 'Tagline Text', 'photoline' ),
					'type'     => 'textarea'
				)
		);
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'home_tagline_bgcolor',
            array(
                'label'      => __( 'Background Color', 'photoline' ),
                'section'    => 'photoline_home_tagline',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'home_tagline_bgimg', array(
		'label' => __( 'Background Image', 'photoline' ),
		'section' =>  'photoline_home_tagline',
		...
		$wp_customize->add_control(
			'frontpage_header',
				array(
					'section'   => 'photoline_home_tagline',
					'label'     => __( 'Show header of front page', 'photoline' ),
					'description'  => __( 'Show header of front page instead Home of Tagline.', 'photoline' ),
					'type'      => 'checkbox'
				)
		);
	/*-----------------------------------------------------------
	...
	$wp_customize->add_section(
		'photoline_blog_set',
		array(
			'title'     => __( 'Blog Settings', 'photoline' ),
			'priority'  => 590
		)
	);
	$wp_customize->add_setting(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'label'    => __( 'Read More Text', 'photoline' ),
			'type'     => 'text'
		)
	);
	/*-----------------------------------------------------------
	...
	$wp_customize->add_control(
		...
		array(
			...
			'label'     => __( 'Show social menu in the header', 'photoline' ),
			'type'      => 'checkbox'
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			'section'  => 'photoline_display_options',
			'label'    => __( 'Opacity hero box', 'photoline' ),
			'description'  => __( 'The percent opacity box of the homepage title in the header.', 'photoline' ),
			'type' => 'select',
			'choices' => array(
				'9' => '90',
				'5' => '50',
	...
	$wp_customize->add_control(
		...
		array(
			'section'   => 'photoline_display_options',
			'label'     => __( 'Numbered navigation', 'photoline' ),
			'type'      => 'checkbox'
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			'section'   => 'photoline_display_options',
			'label'     => __( 'Disable lightbox image', 'photoline' ),
			'type'      => 'checkbox'
		)
	);
	$wp_customize->add_setting(
	...
	$wp_customize->add_control(
		...
		array(
			'section'  => 'photoline_display_options',
			'label'    => __( 'Number of posts image format', 'photoline' ),
			'description'  => __( 'Only works for the Home page with the assigned template Home Mosaic Tiles / Home Square Tiles.', 'photoline' ),
			'type' => 'select',
			'choices' => array(
				'4' => '4',
				'6' => '6',
