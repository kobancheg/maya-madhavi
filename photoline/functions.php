...
function photoline_widgets_init() {
	...
	register_sidebar( array(
       ...
       register_sidebar(array(
            ...
            'description' => __('The headline area Blog page.', 'photoline'),
            'id' => 'blog-intro',
       ...
       register_sidebar(array(
            'name' => __('Home Top', 'photoline'),
            'description' => __('The area Home Page template at the top - above - page content in one line with no columns', 'photoline'),
            'id' => 'home-top',
            'before_title' => '',
            'after_title' => '',
       ...
       register_sidebar(array(
            'name' => __('Home Above', 'photoline'),
            'description' => __('The area Home Page template at the above page content in 2,3,4 column.', 'photoline'),
            'id' => 'home-above',
            'before_title' => '<p class="widget-title">',
            'after_title' => '</p>',
       ...
       register_sidebar(array(
            'name' => __('Home Below', 'photoline'),
            'description' => __('The area Home Page template at the below page content in 2,3,4 column.', 'photoline'),
            'id' => 'home-below',
            'before_title' => '<p class="widget-title">',
            'after_title' => '</p>',
            'before_widget' => '<div class="col">',
       ...
       register_sidebar(array(
            'name' => __('Footer Center', 'photoline'),
       ...
       register_sidebar(array(
            'name' => __('Footer Right', 'photoline'),
 ...
 */
require_once( get_template_directory() .'/inc/add-category-fields.php' );
...
/**
 * Redirect from Category Template
 */
function custom_template( $template ) {

	if ( is_category() ) {
		$term_category_select = get_option('term_category_select_' . get_queried_object()->slug );
	}

	if ( is_category() && $term_category_select !='' ) {
		return get_template_directory() . '/category-' . $term_category_select . '.php';
	}
	return $template;
}
